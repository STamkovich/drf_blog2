...
SECRET_KEY = 'django-insecure-a358uqi&39=wct19&&85#-47vyb=ld!%fj89jyjj1_d+w_a#zr'
...
MIDDLEWARE = [
    ...
    # <- добавьте это именно сюда - данная библиотека позволяет обращаться к вашему django api из других доменов. Не
    # знаю, бывало ли у вас такое
